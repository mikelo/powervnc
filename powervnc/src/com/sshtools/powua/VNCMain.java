...
public class VNCMain
  ...
  public VNCMain(PowuaPanel par) {
	  ...
	  authFrame = new AuthenticationFrame(this);
  }
...
//            desktopScrollPane.add(vc);
  ...
  public void closeConnection() {
    ...
    if (recordingActive) {
      ...
      try {
        ...
        System.err.println("Could not stop recording session.");
        ioe.printStackTrace();
      }
    }
  }
  ...
  void doProtocolInitialisation() throws IOException {
    ...
    application.getContainer().setSize(1000, 800);
    application.getContainer().setResizable(true);
    rfb.readServerInit();
