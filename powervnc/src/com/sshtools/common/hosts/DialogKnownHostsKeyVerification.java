...
public class DialogKnownHostsKeyVerification
   ...
   */
  public DialogKnownHostsKeyVerification(Component parent) throws
   ...
   * @throws InvalidHostFileException
   */
  public DialogKnownHostsKeyVerification(Component parent, String hostFileName) throws
      InvalidHostFileException {
    super(hostFileName);
    this.parent = parent;
  }
  ...
  public void onHostKeyMismatch(final String host,
                                final SshPublicKey recorded,
                                final SshPublicKey actual) throws
   ...
   * @throws TransportProtocolException
   */
  public void onUnknownHost(final String host, final SshPublicKey key) throws
      TransportProtocolException {
  ...
  private String[] getOptions() {
    return isHostFileWriteable() ? new String[] {
        "Always", "Yes", "No"}
        : new String[] {
        "Yes", "No"};
  }
