...
public class DialogHostKeyVerification
   ...
   */
  public DialogHostKeyVerification(Component parent) throws
   ...
   * @throws InvalidHostFileException
   */
  public DialogHostKeyVerification(Component parent, String hostFileName) throws
      InvalidHostFileException {
    super(hostFileName);
    this.parent = parent;
  }
  ...
  public void onHostKeyMismatch(final String host,
                                ...
                                final String actualFingerprint) throws
   ...
   * @throws TransportProtocolException
   */
  public void onUnknownHost(final String host, final String fingerprint) throws
      TransportProtocolException {
