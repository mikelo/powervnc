...
public class StopAction
  ...
  private final static String SMALL_ICON_STOP =
      "/com/sshtools/common/ui/stop.png";
  private final static String LARGE_ICON_STOP = "";
  private final static String SHORT_DESCRIPTION_STOP = "Stop recording";
  private final static String LONG_DESCRIPTION_STOP =
      "Stop recording output to file";
