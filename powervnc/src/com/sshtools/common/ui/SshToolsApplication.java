...
public abstract class SshToolsApplication {
  /**  */
  public final static String PREF_CONNECTION_LAST_HOST =
      "apps.connection.lastHost";

  /**  */
  public final static String PREF_CONNECTION_LAST_USER =
      "apps.connection.lastUser";

  /**  */
  public final static String PREF_CONNECTION_LAST_PORT =
      "apps.connection.lastPort";

  /**  */
  public final static String PREF_CONNECTION_LAST_KEY =
  ...
  static {
    ...
    allLookAndFeelInfo[i.length] = new UIManager.LookAndFeelInfo("Default",
        DEFAULT_LAF);
    allLookAndFeelInfo[i.length +
        1] = new UIManager.LookAndFeelInfo("Cross Platform",
                                           CROSS_PLATFORM_LAF);
  ...
  public SshToolsApplicationContainer getContainerForPanel(
    ...
    for (Iterator i = containers.iterator(); i.hasNext(); ) {
      SshToolsApplicationContainer c = (SshToolsApplicationContainer) i
          .next();
  ...
  public void showAbout(Component parent) {
    ...
    MultilineLabel v = new MultilineLabel(
        getApplicationName()+" "+
   ...
   */
  public SshToolsApplicationContainer newContainer() throws
      SshToolsApplicationException {
    SshToolsApplicationContainer container = null;

    try {
      container = (SshToolsApplicationContainer) defaultContainerClass
          .newInstance();
   ...
   * @throws SshToolsApplicationException
   */
  public void newContainer(SshToolsApplicationContainer container) throws
      SshToolsApplicationException {
    try {
      SshToolsApplicationPanel panel = (SshToolsApplicationPanel) panelClass
          .newInstance();
      panel.init(this);
  ...
  public SshToolsApplicationContainer convertContainer(
      SshToolsApplicationContainer container, Class newContainerClass) throws
      SshToolsApplicationException {
    ...
    try {
      ...
      newContainer = (SshToolsApplicationContainer) newContainerClass
          .newInstance();
  ...
  public static void setLookAndFeel(String className) throws Exception {
    ...
    if (!className.equals(DEFAULT_LAF)) {
      if (className.equals(SYSTEM_LAF)) {
        ...
        String crossPlatformLaf = UIManager
