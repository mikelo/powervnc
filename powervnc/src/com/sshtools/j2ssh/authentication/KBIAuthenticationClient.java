...
public class KBIAuthenticationClient
  ...
  public void authenticate(AuthenticationProtocolClient authentication,
                           String serviceToStart) throws com.sshtools.j2ssh.
      authentication.TerminatedStateException,
      java.io.IOException {
    if (handler == null) {
    ...
    // Read a message
    while (true) {
      msg = authentication.readMessage(SshMsgUserAuthInfoRequest.
                                       SSH_MSG_USERAUTH_INFO_REQUEST);
	...
	if(prompts!=null || (request.getName()!=null && !request.getName().equals("")) || (request.getInstruction()!=null && !request.getInstruction().equals(""))) 
