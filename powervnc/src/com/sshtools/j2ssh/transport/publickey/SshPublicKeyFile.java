...
public class SshPublicKeyFile {
   ...
   * @throws IOException
   */
  public static SshPublicKeyFile parse(File keyfile) throws
   ...
   * @throws InvalidSshKeyException
   */
  public static SshPublicKeyFile parse(byte[] formattedKey) throws
   ...
   * @throws InvalidSshKeyException
   */
  public void setFormat(SshPublicKeyFormat newFormat) throws
      InvalidSshKeyException {
