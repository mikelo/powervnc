...
public abstract class SshMessage {
   ...
   * @since 0.2.0
   */
  protected final void fromByteArray(ByteArrayReader data) throws
   ...
   * @since 0.2.0
   */
  protected abstract void constructByteArray(ByteArrayWriter baw) throws
      InvalidMessageException;
   ...
   * @since 0.2.0
   */
  protected abstract void constructMessage(ByteArrayReader bar) throws
      InvalidMessageException;
}
