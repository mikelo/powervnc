...
public class SessionOutputReader {
   ...
   */
  public synchronized boolean waitForString(String str, SessionOutputEcho echo) throws
   ...
   * @see waitForString(String, int, SessionOutputEcho)
   */
  public synchronized boolean waitForString(String str) throws
      InterruptedException {
   ...
   * @see waitForString(String, int, SessionOutputEcho)
   */
  public synchronized boolean waitForString(String str, int timeout) throws
      InterruptedException {
  ...
  public synchronized boolean waitForString(String str, int timeout,
    ...
    while ( (output.indexOf(str, pos) == -1)
      ...
      wait( (timeout > 0) ? (timeout - (System.currentTimeMillis() - time))
           : 0);
   ...
   */
  public synchronized void echoLineByLineToClose(SessionOutputEcho echo) throws
      InterruptedException {
