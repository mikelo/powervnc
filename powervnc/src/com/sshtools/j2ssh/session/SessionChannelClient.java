...
public class SessionChannelClient
   ...
   * @throws IOException
   */
  public boolean requestX11Forwarding(int display, X11Util.X11Cookie cookie) throws
      IOException {
    ...
    baw.writeString(cookie.getAuthType());
    baw.writeString(cookie.getFakeAuthData());
