...
public abstract class SshServer {
  ...
  protected void startCommandSocket() throws IOException {
    try {
       ...
       * server to stop.
       */
        commandServerSocket = new ServerSocket( ( (ServerConfiguration)
                                                 ConfigurationLoader
                                                 .getConfiguration(
  ...
  protected void startServerSocket() throws IOException {
    listener = new ConnectionListener( ( (ServerConfiguration)
                                        ConfigurationLoader
  ...
  class ConnectionListener
    ...
    public void run() {
      try {
        ...
        TransportProtocolEventHandler eventHandler = new
