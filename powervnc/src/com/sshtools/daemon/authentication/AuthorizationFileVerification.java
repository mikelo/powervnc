...
public class AuthorizationFileVerification
  ...
  public boolean verifyKeySignature(String username, String algorithm,
                                    byte[] encoded, String service,
                                    byte[] sessionId, byte[] signature) throws
      IOException {
    try {
  ...
  private SshPublicKey getAuthorizedKey(String username, String algorithm,
    ...
    NativeAuthenticationProvider provider = NativeAuthenticationProvider
        .getInstance();
   ...
   * @throws IOException
   */
  public boolean acceptKey(String username, String algorithm, byte[] encoded) throws
      IOException {
    try {
