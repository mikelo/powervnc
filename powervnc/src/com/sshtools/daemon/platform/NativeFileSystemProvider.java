...
public abstract class NativeFileSystemProvider {
  ...
  static {
    try {
      if (ConfigurationLoader.isConfigurationAvailable(
        ...
        Class cls = ConfigurationLoader.getExtensionClass( ( (
            PlatformConfiguration) ConfigurationLoader
   ...
   * @throws IOException
   */
  public abstract String getCanonicalPath(String path) throws IOException,
   ...
   * @throws IOException
   */
  public abstract boolean makeDirectory(String path) throws
   ...
   * @throws FileNotFoundException
   */
  public abstract FileAttributes getFileAttributes(String path) throws
   ...
   */
  public abstract FileAttributes getFileAttributes(byte[] handle) throws
   ...
   * @throws IOException
   */
  public abstract byte[] openDirectory(String path) throws
      PermissionDeniedException, FileNotFoundException, IOException;
   ...
   * @throws EOFException
   */
  public abstract SftpFile[] readDirectory(byte[] handle) throws
      InvalidHandleException, EOFException, IOException;
  ...
  public abstract void writeFile(byte[] handle, UnsignedInteger64 offset,
                                 byte[] data, int off, int len) throws
      InvalidHandleException, IOException;
   ...
   * @throws IOException
   */
  public abstract void closeFile(byte[] handle) throws InvalidHandleException,
      IOException;
   ...
   * @throws FileNotFoundException
   */
  public abstract void removeFile(String path) throws PermissionDeniedException,
      IOException, FileNotFoundException;
   ...
   * @throws IOException
   */
  public abstract void renameFile(String oldpath, String newpath) throws
      PermissionDeniedException, FileNotFoundException, IOException;
   ...
   * @throws IOException
   */
  public abstract void removeDirectory(String path) throws
      PermissionDeniedException, FileNotFoundException, IOException;
   ...
   * @throws FileNotFoundException
   */
  public abstract void setFileAttributes(String path, FileAttributes attrs) throws
   ...
   * @throws InvalidHandleException
   */
  public abstract void setFileAttributes(byte[] handle, FileAttributes attrs) throws
   ...
   * @throws PermissionDeniedException
   */
  public abstract SftpFile readSymbolicLink(String path) throws
   ...
   * @throws PermissionDeniedException
   */
  public abstract void createSymbolicLink(String link, String target) throws
      UnsupportedFileOperationException, FileNotFoundException,
      IOException, PermissionDeniedException;

  public abstract String getDefaultPath(String username) throws
      FileNotFoundException;
