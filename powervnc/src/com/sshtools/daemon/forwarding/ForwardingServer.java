...
public class ForwardingServer
  ...
  public ForwardingServer(ConnectionProtocol connection) throws IOException {
    ...
    connection.allowGlobalRequest(ForwardingClient.REMOTE_FORWARD_REQUEST,
                                  this);
    connection.allowGlobalRequest(ForwardingClient.
  ...
  public Channel createChannel(String channelType, byte[] requestData) throws
    ...
    try {
      ...
      ForwardingConfiguration config = getLocalForwardingByAddress(
          originatingHost,
          originatingPort);
      ...
      ForwardingSocketChannel channel = config
          .createForwardingSocketChannel(channelType, hostToConnect,
  ...
  protected ForwardingConfiguration getLocalForwardingByAddress(
      String orginatingAddress, int originatingPort) throws
   ...
   * @throws ForwardingConfigurationException
   */
  protected void removeRemoteForwarding(String addressToBind, int portToBind) throws
      ForwardingConfigurationException {
