...
public class PlatformConfiguration
  ...
  private static final String NATIVE_AUTH_ELEMENT =
  ...
  public String toString() {
    ...
    while (it.hasNext()) {
      ...
      xml += ("   " + "<" + NATIVE_SETTING_ELEMENT + " " + NAME_ATTRIBUTE
              + "=\"" + entry.getKey().toString() + "\" " + VALUE_ATTRIBUTE
  ...
  class PlatformConfigurationSAXHandler
            ...
            if (!mount.trim().equals("/")) {
              try {
                ...
                if (!vfsMounts.containsKey(
                  ...
                  throw new SAXException("The mount " + mount
                                         + " is already defined");
                }
              }
    ...
    public void characters(char[] ch, int start, int length) throws
      ...
      if (currentElement.equals(NATIVE_AUTH_ELEMENT)) {
        nativeAuthenticationProvider = new String(ch, start, length)
            .trim();
