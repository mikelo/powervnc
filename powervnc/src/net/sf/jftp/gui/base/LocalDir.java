...
public class LocalDir extends DirPanel implements ListSelectionListener,
                                                  ActionListener,
                                                  ConnectionListener,
                                                  KeyListener
{
    ...
    */
    public void fresh()
    {
        ...
        //jftp.paintImmediately(0,0,jftp.getSize().width,jftp.getSize().height);
        if(JFtp.mainFrame != null)
        {
            JFtp.mainFrame.setCursor(Cursor.DEFAULT_CURSOR);
        }
