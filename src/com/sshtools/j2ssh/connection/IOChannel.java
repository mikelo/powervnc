...
public abstract class IOChannel
  ...
  public void bindOutputStream(OutputStream boundOutputStream) throws
      IOException {
    ...
    if ( (boundInputStream != null) && (boundOutputStream != null)
      ...
      while (true) {
        try {
          ...
          SshMsgChannelData msg = (SshMsgChannelData) incoming
              .peekMessage(SshMsgChannelData.SSH_MSG_CHANNEL_DATA);
