...
public class FileAttributes {
  ...
  public void setPermissions(String newPermissions) {
    ...
    if (permissions != null) {
      ...
      cp = cp
          | ( ( (permissions.intValue() & S_IFSOCK) == S_IFSOCK) ? S_IFSOCK
             : 0);
      cp = cp
  ...
  public boolean isDirectory() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFDIR) ==
  ...
  public boolean isFile() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFREG) ==
  ...
  public boolean isLink() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFLNK) ==
  ...
  public boolean isFifo() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFIFO) ==
  ...
  public boolean isBlock() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFBLK) ==
  ...
  public boolean isCharacter() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFCHR) ==
  ...
  public boolean isSocket() {
    if (permissions == null) {
      ...
      return (permissions.intValue() & FileAttributes.S_IFSOCK) ==
