...
public class SshClient {
  ...
  public int authenticate(SshAuthenticationClient auth, String hostname) throws IOException {
    ...
    authenticationState = authentication.authenticate(auth, connection, hostname);
   ...
   * @since 0.2.0
   */
  public boolean acceptsKey(String username, SshPublicKey key) throws
      IOException {
    if (authenticationState != AuthenticationProtocolState.COMPLETE) {
   ...
   * @since 0.2.0
   */
  public void connect(String hostname, HostKeyVerification hosts) throws
      IOException {
   ...
   * @since 0.2.0
   */
  public void connect(String hostname, int port, HostKeyVerification hosts) throws
      IOException {
  ...
  public void connect(SshConnectionProperties properties,
    ...
    TransportProvider provider = TransportProviderFactory
        .connectTransportProvider(properties /*, connectTimeout*/,
                                  socketTimeout);
   ...
   * @throws IOException
   */
  public SftpClient openSftpClient(ChannelEventListener eventListener) throws
      IOException {
...
// Initialize SFTP
   ...
   * @since 0.2.0
   */
  public void allowChannelOpen(String channelName, ChannelFactory cf) throws
      IOException {
