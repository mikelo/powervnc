...
public abstract class SshKeyPair {
   ...
   */
  public SshPrivateKey setPrivateKey(byte[] encoded) throws
   ...
   * @throws InvalidSshKeyException
   */
  public SshPublicKey setPublicKey(byte[] encoded) throws
      InvalidSshKeyException {
   ...
   * @throws InvalidSshKeyException
   */
  public abstract SshPrivateKey decodePrivateKey(byte[] encoded) throws
      InvalidSshKeyException;
   ...
   * @throws InvalidSshKeyException
   */
  public abstract SshPublicKey decodePublicKey(byte[] encoded) throws
      InvalidSshKeyException;
}
