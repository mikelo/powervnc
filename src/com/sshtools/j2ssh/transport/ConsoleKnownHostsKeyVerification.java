...
public class ConsoleKnownHostsKeyVerification
   ...
   * @since 0.2.0
   */
  public ConsoleKnownHostsKeyVerification(String knownhosts) throws
  ...
  private void getResponse(String host, SshPublicKey pk) throws
      InvalidHostFileException, IOException {
    String response = "";
