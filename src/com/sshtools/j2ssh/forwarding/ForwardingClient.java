...
public class ForwardingClient
  ...
  private XDisplay xDisplay;
    private X11Util.X11Cookie cookie;
   ...
   * @param localDisplay
   */
  public void enableX11Forwarding(XDisplay localDisplay, X11Util.X11Cookie cookie) {
   ...
   * @throws ForwardingConfigurationException
   */
  public ForwardingConfiguration getRemoteForwardingByName(String name) throws
      ForwardingConfigurationException {
   ...
   * @throws ForwardingConfigurationException
   */
  public void removeRemoteForwarding(String name) throws IOException,
      ForwardingConfigurationException {
    if (!remoteForwardings.containsKey(name)) {
      throw new ForwardingConfigurationException(
          "The name is not a valid forwarding configuration");
  ...
  public void addRemoteForwarding(String uniqueName, String addressToBind,
    ...
    remoteForwardings.put(uniqueName,
                          new ForwardingConfiguration(uniqueName, addressToBind,
        portToBind,
  ...
  public Channel createChannel(String channelType, byte[] requestData) throws
	...
	if(xDisplay.isLocalUNIXSocket()) {
	    UnixSocket socket = new UnixSocket("/tmp/.X11-unix/X"+xDisplay.getDisplay());
	    x11ForwardingConfiguration.start();
	    ForwardingUNIXSocketX11Channel channel = x11ForwardingConfiguration
		.createForwardingUNIXSocketX11Channel(channelType,
					       x11ForwardingConfiguration.
					       getHostToConnect(),
					       x11ForwardingConfiguration.
					       getPortToConnect(),
					       originatingHost, originatingPort,
					       cookie.getAuthType(), cookie.getFakeAuthData(), cookie.getRealAuthData());
	    ...
	    x11ForwardingConfiguration.start();
	    ForwardingSocketX11Channel channel = x11ForwardingConfiguration
		.createForwardingSocketX11Channel(channelType,
					       x11ForwardingConfiguration.
					       getHostToConnect(),
					       x11ForwardingConfiguration.
					       getPortToConnect(),
   ...
   * @throws ForwardingConfigurationException
   */
  public void startX11Forwarding() throws IOException,
      ForwardingConfigurationException {
   ...
   * @throws ForwardingConfigurationException
   */
  public void stopRemoteForwarding(String name) throws IOException,
      ForwardingConfigurationException {
    if (!remoteForwardings.containsKey(name)) {
      throw new ForwardingConfigurationException(
