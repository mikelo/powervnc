...
public class XmlServerConfigurationContext
  ...
  public void initialize() throws ConfigurationException {
    if (serverResource != null) {
      try {
        ServerConfiguration y = new ServerConfiguration(ConfigurationLoader
            .loadFile(serverResource));
    ...
    if (platformResource != null) {
      try {
        PlatformConfiguration z = new PlatformConfiguration(ConfigurationLoader
            .loadFile(platformResource));
