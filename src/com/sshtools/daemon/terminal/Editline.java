...
public class Editline {
  ...
  //setCharAt
  private void insertCharAt(int pos, char ch) throws BufferOverflowException,
  ...
  //removeChatAt
  private void insertStringAt(int pos, String str) throws
      BufferOverflowException, IndexOutOfBoundsException, IOException {
    storeSize();
