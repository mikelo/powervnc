 ...
 * file (~/.sshterm/GSI-SSHTerm.properties), which can over-ride those in
 * the res/common/default.properties file.  The following are important
 * defaults (with the values they defualt to with no 
 ...
 *
 * Proxy saving: these four settings set whether proxies created from Grid
 *	credentials are saved into the defualt proxy location for future use:
 *	
 *	sshterm.proxy.save.myproxy=false
 *	sshterm.proxy.save.gridproxyinit=false
 *	sshterm.proxy.save.pkcs12=false
 *	sshterm.proxy.save.browser=false
 *
 *
 */
