...
public abstract class SshToolsApplicationApplet
  ...
  public void initApplet() throws IOException {
    ...
    toolBar = getParameter("sshapps.ui.toolBar",
                           "true").equalsIgnoreCase("true");
    menuBar = getParameter("sshapps.ui.menuBar",
                           "true").equalsIgnoreCase("true");
   ...
   * @throws SshToolsApplicationException
   */
  public abstract SshToolsApplicationPanel createApplicationPanel() throws
      SshToolsApplicationException;
  ...
  public class SshToolsApplicationAppletContainer
    ...
    public java.awt.Component getWindow() { return SshToolsApplicationApplet.this; }
