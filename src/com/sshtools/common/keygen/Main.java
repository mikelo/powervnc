...
public class Main
  ...
  final static String ICON =
      "/com/sshtools/common/authentication/largepassphrase.png";
  JButton close;
  JButton generate;
  KeygenPanel keygen;
    ...
    Runnable r = new Runnable() {
      public void run() {
        try {
          if (keygen.getAction() == KeygenPanel.CHANGE_PASSPHRASE) {
          ...
          else if (keygen.getAction() ==
                   KeygenPanel.CONVERT_IETF_SECSH_TO_OPENSSH) {
            ...
            JOptionPane.showMessageDialog(Main.this,
                   ...
                   KeygenPanel.CONVERT_OPENSSH_TO_IETF_SECSH) {
            monitor.setNote("Converting key file");
            writeString(outputFile,
                        SshKeyGenerator.convertPublicKeyFile(
