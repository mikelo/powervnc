...
public abstract class AbstractHostKeyVerification
   ...
   * @throws InvalidHostFileException
   */
  public AbstractHostKeyVerification(String hostFileName) throws
   ...
   */
  public abstract void onDeniedHost(String host) throws
   ...
   * @throws TransportProtocolException
   */
  public abstract void onUnknownHost(String host, String hostKeyFingerprint) throws
      TransportProtocolException;
   ...
   * @throws InvalidHostFileException
   */
  public void allowHost(String host, String hostKeyFingerprint, boolean always) throws
      InvalidHostFileException {
    if (log.isDebugEnabled()) {
   ...
   * @throws InvalidHostFileException
   */
  public void denyHost(String host, boolean always) throws
      InvalidHostFileException {
    if (log.isDebugEnabled()) {
