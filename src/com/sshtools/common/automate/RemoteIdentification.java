...
public class RemoteIdentification {
   ...
   * @throws RemoteIdentificationException
   */
  public AuthorizedKeysFormat getAuthorizedKeysFormat() throws
  ...
  public boolean configureUserAccess(SftpClient sftp, String serverId,
                                     ...
                                     SshPublicKey pk,
                                     String authorizationFile, int mode) throws
      RemoteIdentificationException {
  ...
  public boolean configureUserAccess(final SftpClient sftp,
                                     final String serverId, String system,
                                     String username, List keys,
                                     String authorizationFile, int mode) throws
      RemoteIdentificationException {
    try {
      ...
      // Output the new file
      log.info("Writing new authorized keys file to " + authorizationFile);
      ...
      out.write(AuthorizedKeys.create(authorizedKeys, serverId, system,
        ...
        public void saveFile(String filename, byte[] filedata) throws
            IOException {
          //SftpFile file = null;
