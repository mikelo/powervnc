...
public class KBIRequestHandlerDialog
  ...
  public KBIRequestHandlerDialog() {
    super( (Frame)null, "Authentication Dialog", true);
    init();
  }
  ...
  public KBIRequestHandlerDialog(Frame frame) {
    super(frame, "Authentication Dialog", true);
    init();
  }
  ...
  public KBIRequestHandlerDialog(Dialog dialog) {
    super(dialog, "Authentication Dialog", true);
    init();
  }
  ...
  public void showPrompts(String name, String instruction, KBIPrompt[] prompts) {
    if(name==null || name.equals("")) setTitle("Authentication Prompt"); else setTitle(name);
    ...
    if(prompts!=null) centerPanel.add(promptPanel, BorderLayout.CENTER);
